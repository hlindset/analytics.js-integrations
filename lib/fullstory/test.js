  ...
  describe('after loading', function(){
    ...
    describe('#identify', function(){
      ...
      it('should map name and email for multi word keys/uppercase', function(){
        analytics.identify('id', { name: 'Test', "First Name": "Steven", "Last Name": "Miller", Email: "test@test.com" });
        analytics.called(window.FS.identify, 'id', { displayName: 'Test', email: 'test@test.com', "FirstName_str": "Steven", "LastName_str": "Miller" });
      });
